...
const DoctorCard = ({ image, name, speciality }) => {
  return (
    <div className="border rounded-lg shadow-lg w-48 text-center bg-white hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out transform">
      {/* Doctor's Image */}
      <img
        src={image}
        alt={`${name}'s profile`}
