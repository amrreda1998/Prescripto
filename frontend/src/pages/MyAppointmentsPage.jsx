          ...
          {appointments.map((appointment) => (
            ...
            >
              <div className="flex items-center gap-5 w-full lg:w-auto flex-col lg:flex-row">
                ...
                <div className="space-y-4 lg:pl-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-xl font-bold text-gray-800">{appointment.doctor.name}</p>
                  </div>
              ...
              <div className="mt-5 lg:mt-0 space-y-3 flex flex-col w-full lg:w-auto lg:items-center">
                ...
                <button className="w-full  px-8 py-2 bg-red-500 text-white rounded-full shadow-lg hover:bg-red-600 transition">
                  Cancel Appointment
                </button>
              </div>
            </div>
